<?php 
    ...
    /////////////
    // if (isset($_POST["filter"]) && $_POST["filter"] === "filter-favorite") {
    //     $temp_list = [];
    ...
    // } elseif (isset($_POST["filter"]) && $_POST["filter"] === "filter-unfavorite") {
    //     $temp_list = [];
    ...
    // } elseif (isset($_POST["filter"]) && $_POST["filter"] === "filter-all") {
    //     $disc_visible = $disc_list;
    // }
    ////////////
